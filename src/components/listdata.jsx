...
function Listdata() {
  ...
  const buttonHapus = (id) => {
    ...
    // Filter data untuk menghilangkan item yang dihapus
  ...
  return (
    <>
      ...
      <div className="flex mb-10">
        <button className="buttom-all border border-solid border-gray-500 rounded-xl py-0.5 px-2.5 mx-1">ALL</button>
        <button className="buttom-active border border-solid border-gray-500 rounded-xl py-0.5 px-2.5 mx-2">ACTIVE</button>
        <button className="buttom-completed border border-solid border-gray-500 rounded-xl py-0.5 px-2.5 mx-2">COMPLETED</button>
      </div>
      <div>
